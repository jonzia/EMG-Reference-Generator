...
fWaveLatency = {
    ...
    "fibular": [[47.8, 49.1, 50.4, 51.6, 52.9, 54.2, 55.5, 56.8, 58.1], [47.8, 49.1, 50.4, 51.6, 52.9, 54.2, 55.5, 56.8, 58.1], [47.8, 49.1, 50.4, 51.6, 52.9, 54.2, 55.5, 56.8, 58.1]],
...
nerveKeywords = ["median", "ulnar", "radial", "musculo", "peroneal", "fibular", "tibial", "sural"]
        ...
        for i in range(2,numRows):
            ...
            for j, word in enumerate(newTable.cell(i,0).text.split(" ")):
                if word.lower() in levelKeywords:
                    levelKeyword = word.lower()
                    FLAG = True
                    break
            if not FLAG:
                levelKeyword = "default"
